...
public class Tests {
    public static void main(String[] args) {
        // How to run
//        runTests(new ContiguousList<>());
//        runTests(new ConnectedList<>());
        // Uncomment once you have implemented the ListInterface
        // with one of the classes
    }

    public static void runTests(ListInterface<String> cl) {
